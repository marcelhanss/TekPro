...
<body class="bg-gray-100">
    ...
    <!-- Menampilkan judul buku pertama dalam tag <h1> -->
    @if($books->count() > 0)
    ...
    <div class="container mx-auto mt-10 grid grid-cols-3 gap-8">
        @foreach ($books as $book)
        <div class="bg-white p-4 rounded shadow-lg">
            <!-- Display the image and book title -->
            <img src="{{ asset('storage/' . $book->gambar) }}" alt="{{ $book->judul }}" class="w-full h-64 object-cover rounded">
